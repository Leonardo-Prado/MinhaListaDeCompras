...
public class RVComprasAdapter extends RecyclerView.Adapter {
    Context context;
    ...
    public RVComprasAdapter(Context context, List<ListaCompras> compras) {
...
class ComprasViewHolder extends RecyclerView.ViewHolder{
    ...
    private RVComprasItensAdapter rvItensAdapter;
    boolean visivel = false;

    public ComprasViewHolder(@NonNull View view, final Context context) {
        super(view);
        this.context = context;
        ...
        rvItensAdapter = new RVComprasItensAdapter(context,listaCompras);
