...
public class RVListaComprasOnlineItensAdapter extends RecyclerView.Adapter {
    Context context;
    ...
    public RVListaComprasOnlineItensAdapter(Context context,ListaCompras listaCompras) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ListaDeComprasOnlineItensViewHolder holder = new ListaDeComprasOnlineItensViewHolder(view,myRef,listaUId);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        final ListaDeComprasOnlineItensViewHolder viewHolder = (ListaDeComprasOnlineItensViewHolder) holder;
...
class ListaDeComprasOnlineItensViewHolder extends RecyclerView.ViewHolder{
    TextView tvNome;
    ...
    public ListaDeComprasOnlineItensViewHolder(View view, final DatabaseReference myRef, final String listaUId) {
        super(view);
