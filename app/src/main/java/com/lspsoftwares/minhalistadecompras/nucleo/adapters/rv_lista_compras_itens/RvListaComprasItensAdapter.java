...
public class RvListaComprasItensAdapter extends RecyclerView.Adapter {
    ...
    public RvListaComprasItensAdapter(Context context,String listaUId) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ListaDeComprasItensViewHolder holder = new ListaDeComprasItensViewHolder(view,myRef,listaUId,context);
        return holder;
    }
...
class ListaDeComprasItensViewHolder extends RecyclerView.ViewHolder{
    ...
    public ListaDeComprasItensViewHolder(View view, final DatabaseReference myRef, final String listaUId, final Context context) {
        super(view);
        this.context = context;
            ...
            imbRemoveItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(VariaveisEstaticas.getUsuario().getUid().equals(listaCompras.getCriadorUid())) {
                        ...
                        update.put(listaUId, VariaveisEstaticas.getListaCompras().get(VariaveisEstaticas.getListaCompras().indexOf(listaCompras)));
                        ...
                        VariaveisEstaticas.getListaCompras().get(VariaveisEstaticas.getListaCompras().indexOf(listaCompras)).getItens().remove(position);
                        update.put(l, VariaveisEstaticas.getListaCompras().get(VariaveisEstaticas.getListaCompras().indexOf(listaCompras)));
                        myRef.child("Lista").updateChildren(update);
                        notificarAtualização();
                    }
                }
